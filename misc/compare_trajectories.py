...
CHECKPOINTS = {
    ...
    # "XPrefs": "/home/connor/Documents/Xpref/learned_reward_models/rlhf_mediumstick_cross_5k",
    "Buckets": "/home/connor/Documents/Xpref/learned_reward_models/tcc_buckets",

}

EMBODIMENT_TARGETS = ["mediumstick", "mediumstick"]
GOOD_TRAJECTORY_INDEX = 11
BAD_TRAJECTORY_INDEX = 1721
...
X_MAGICAL_DATA_PATH = os.path.expanduser("~/Documents/Xpref/trajectories_num_blocks")
CONFIG.data.root = X_MAGICAL_DATA_PATH
CONFIG.data.demonstrations_root = X_MAGICAL_DATA_PATH
...
def calculate_goal_embedding(exp_dir, device="cuda"):
    try:
        ...
        goal = load_pickle(exp_dir, "goal_emb.pkl")
...
if __name__ == "__main__":
    ...
    device = load_device()
    print(len(traj_data))
    # print(traj_data.trajectories[EMBODIMENT_TARGETS[0]])
