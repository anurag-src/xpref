...
FLAGS = flags.FLAGS
flags.DEFINE_string("experiment_path", None, "Path to pretraining experiment.")
...
def main(_):
    with open(os.path.join(FLAGS.experiment_path, "metadata.yaml"), "r") as fp:
